...
class Mage_Install_Model_Installer_Config extends Mage_Install_Model_Installer_Abstract
{
    ...
    {
        $prefix = $secure ? '<span class="skimwords-unlinked">index.php/install/wizard/checkSecureHost</span>/' : '<span class="skimwords-unlinked">index.php/install/wizard/checkHost</span>/';
        try {
